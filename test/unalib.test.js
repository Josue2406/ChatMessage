...
describe('UNA-LIB Validación de Mensajes', () => {
    
    describe('Prevención de XSS', () => {
        test('Debe bloquear script básico', () => {
        ...
        test('Debe detectar intentos de inyección', () => {
    ...
    describe('Validación de URLs de Imágenes', () => {
        test('Debe validar URLs de imágenes con extensión JPG', () => {
            const imageUrl = 'https://example.com/imagen.jpg';
            expect(unalib.isValidMediaURL(imageUrl)).toBe(true);
        });
        
        test('Debe validar URLs de imágenes con extensión PNG', () => {
            const imageUrl = 'https://example.com/foto.png';
            expect(unalib.isValidMediaURL(imageUrl)).toBe(true);
        });
        
        test('Debe validar URLs de imágenes con extensión GIF', () => {
            const imageUrl = 'https://i.imgur.com/animacion.gif';
            expect(unalib.isValidMediaURL(imageUrl)).toBe(true);
        });
        
        test('Debe crear HTML para imagen válida', () => {
    ...
    describe('Validación de URLs de Videos', () => {
        ...
        test('Debe crear HTML para video válido', () => {
        ...
        test('Debe rechazar URLs de video inválidas', () => {
            const invalidUrls = [
                'not-a-url',
    ...
    // Pruebas de validación de colores
    describe('Validación de Colores', () => {
        test('Debe validar colores hexadecimales válidos', () => {
    ...
    describe('Integración Completa', () => {
        test('Debe procesar mensaje normal correctamente', () => {
            ...
            expect(result.mensaje).toBe('Hola, ¿cómo están?');
        ...
        test('Debe manejar JSON malformado', () => {
            const badInput = 'esto no es JSON válido';
